...
CREATE TABLE IF NOT EXISTS `kart` (
    ...
    `type` BIT NOT 0,
    `status` ENUM('disponible', 'reservado', 'mantenimiento'),
    PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pista` (
    ...
    `difficulty` ENUM('infantil', 'familiar', 'adultos'),
...
INSERT INTO `usuario` VALUES ('Carlos', 'p02ritac@uco.es','15/08/2002', NULL);
INSERT INTO `usuario` VALUES ('Silvia', 'i02rofls@uco.es','02/09/2002', NULL);
INSERT INTO `usuario` VALUES ('Alba', 'i02pajia@uco.es','23/12/2002', NULL);
INSERT INTO `usuario` VALUES ('Moises', 'i92mocem@uco.es','05/04/2001', NULL);
...
INSERT INTO `pista` VALUES ('cordoba',0, 'infantil', 0);
INSERT INTO `pista` VALUES ('sevilla',0, 'familiar', 0);
INSERT INTO `pista` VALUES ('madrid',0, 'adultos', 0);
INSERT INTO `pista` VALUES ('barcelona',0, 'adultos', 0);

INSERT INTO `reserva` VALUES ('p02ritac@uco.es', '04/11/2022', 120, 'cordoba', 20);
INSERT INTO `reserva` VALUES ('i02rofls@uco.es', '13/08/2022', 120, 'sevilla', 20);
INSERT INTO `reserva` VALUES ('i02pajia@uco.es', '01/01/2022', 120, 'barcelona', 20);
INSERT INTO `reserva` VALUES ('i92mocem@uco.es', '23/12/2020', 120, 'madrid', 20);
