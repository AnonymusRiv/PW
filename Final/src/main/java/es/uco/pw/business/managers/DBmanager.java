...
public class DBmanager {
    ...
    private DBmanager(String url, String user, String password, InputStream properties) {
    	this.url = url;
        this.user = user;
    ...
    public static DBmanager getInstance(String url, String user, String password, InputStream properties) {
      if (instance == null) {
        instance = new DBmanager(url,user,password,properties);
      }
      return instance;
    }
