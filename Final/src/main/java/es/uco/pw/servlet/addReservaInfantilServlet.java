 ...
 */
@WebServlet(name="addReservaInfantil", urlPatterns="/addReservaInfantil")
public class addReservaInfantilServlet extends HttpServlet {
	...
	protected void doPost(
		    ...
		    if (customerBean == null || customerBean.getEmailUser().equals("")) {
		      ...
		      gestorReservas.hacerReservaIndividualInfantil(reserva);
