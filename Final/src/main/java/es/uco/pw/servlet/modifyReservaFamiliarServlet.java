 ...
 */
@WebServlet(name="modifyReservaFamiliar", urlPatterns="/modifyReservaFamiliar")
public class modifyReservaFamiliarServlet extends HttpServlet {
	...
	protected void doPost(
		    ...
		    if (customerBean == null || customerBean.getEmailUser().equals("")) {
		      ...
		      ArrayList<ReservaFamiliarDTO> reservasI = gestorReservas.reservasFuturasFamiliar();
		      ...
		      if(reserva != null) {
			      ...
			      gestorReservas.modificarReservaIndividualFamiliar(reserva, id);		      }
