...
<%@ page
	import="java.text.SimpleDateFormat,es.uco.pw.business.DTO.KartDTO,es.uco.pw.business.DTO.UsuarioDTO,es.uco.pw.business.managers.DBmanager,es.uco.pw.business.managers.GestorUsuarios,es.uco.pw.business.managers.GestorPistas,java.util.ArrayList"%>
<html>
<%
